...
var fight = function(enemyName) {
    ...
    while(enemyHealth > 0 && playerHealth > 0) {
        ...
        if (enemyHealth <= 0) {
            ...
            // award player money winning
            playerMoney = playerMoney + 20;

            // leave while() loop snce enemy is dead
            break;
        }else {
    ...
    for(var i = 0; i < enemyNames.length; i++) {
        if (playerHealth > 0) {
            ...
            if (playerHealth > 0 && i < enemyNames.length -1) {
                ...
                // if yes, take them to the store() finction
                if (storeConfirm) {
                    shop();
                }
            }
...
var shop = function() {
    ...
    switch (shopOptionPrompt) {
        ...
        case "upgrade":
            if (playerMoney >= 7) {
                window.alert("Upgrading player's attack by 6 for 7 dollats.");
